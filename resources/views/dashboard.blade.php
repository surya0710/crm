                  ...
                  <div class="card-body latest-activity">
                    <ul>
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="{{ asset('assets/css/icon-sprite.svg#box') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-warning border-light-warning">
                          <svg class="stroke-icon stroke-warning">
                            <use href="{{ asset('assets/css/icon-sprite.svg#dolar') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-danger border-light-danger">
                          <svg class="stroke-icon stroke-danger">
                            <use href="{{ asset('assets/css/icon-sprite.svg#round-right') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="{{ asset('assets/css/icon-sprite.svg#pie-chart') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-warning border-light-warning">
                          <svg class="stroke-icon stroke-warning">
                            <use href="{{ asset('assets/css/icon-sprite.svg#globe') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-danger border-light-danger">
                          <svg class="stroke-icon stroke-none">
                            <use href="{{ asset('assets/css/icon-sprite.svg#box-user') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0 bg-light-primary border-light-primary">
                          <svg class="stroke-icon stroke-primary">
                            <use href="{{ asset('assets/css/icon-sprite.svg#work-bag') }}"></use>
                          </svg>
                        </div>
                        <div class="flex-grow-1">
                          <a href="product-page.html">
                      ...
                      <li class="d-flex align-items-center justify-content-between gap-2">
                        <div class="d-flex gap-2">
                          ...
                          <div>
                            ...
                            <p>
                              <svg class="stroke-icon">
                                <use href="{{ asset('assets/css/icon-sprite.svg#map-icon') }}"></use>
                              </svg>Texas
                            </p>
                          </div>
                        </div>
                  ...
                  <div class="card-body total-invest">
                    <div class="row">
                      ...
                      <div class="col-6 col-md-12 invest-content text-center">
                        <svg class="stroke-icon">
                          <use href="{{ asset('assets/css/icon-sprite.svg#chart-invest') }}"></use>
                        </svg>
